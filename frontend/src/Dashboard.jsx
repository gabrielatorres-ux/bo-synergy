mkdir -p ;/bo-synergy/frontend/src/components
cat > ~/bo-synergy/frontend/src/components/Dashboard.jsx << 'EOF'
    ...
    <div style={styles.container}>
      ...
      <div style={styles.statsGrid}>
        <div style={styles.statCard}>
          ...
          <div>
            <h3 style={styles.statNumber}>{estadisticas.totalPacientes}</h3>
        ...
        <div style={styles.statCard}>
          <span style={styles.statIcon}>📋</span>
          <div>
            <h3 style={styles.statNumber}>{estadisticas.totalConsultas}</h3>
        ...
        <div style={styles.statCard}>
          <span style={styles.statIcon}>🩺</span>
          <div>
            <h3 style={styles.statNumber}>{estadisticas.totalEMI + estadisticas.totalEMP + estadisticas.totalEMR}</h3>
        ...
        <div style={styles.statCard}>
          ...
          <div>
            <h3 style={styles.statNumber}>{estadisticas.totalVulnerabilidad}</h3>
