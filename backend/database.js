...
// ===== PRUEBA DE CONEXIÓN DIRECTA A SUPABASE =====
(async () => {
  try {
    ...
    console.log('✅ PRUEBA DIRECTA: Conexión exitosa a Supabase');
    console.log('📅 Hora del servidor:', result.rows[0].now);
    await pool.end();
  } catch (error) {
    console.error('❌ PRUEBA DIRECTA: Error de conexión:', error.message);
